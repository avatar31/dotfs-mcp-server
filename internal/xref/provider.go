...
type Provider interface {
	ClientSession(ctx context.Context, repo, repoDir string, lang utils.Language) (Session, error)
...
func (p managerProvider) ClientSession(ctx context.Context, repo, repoDir string, lang utils.Language) (Session, error) {
